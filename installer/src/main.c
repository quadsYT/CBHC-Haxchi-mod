...
{
#ifdef CB
	println_noflip(0,"CBHC v1.6 Mod by Flump");
#else
	println_noflip(0,"Haxchi v2.5u2 Mod by Flump");
#endif
	println_noflip(1," ");
}
...
#ifdef CB
		println_noflip(4," ");
		println_noflip(5,"Press A to install CBHC, B to remove CBHC or HOME to Exit.");
		println_noflip(6,"WARNING, INSTALLING CBHC CAN POTENTIALLY BRICK YOUR SYSTEM!");
#else
		println_noflip(4," ");		
		println_noflip(5,"This will install Haxchi. To remove it you have to delete and");
		println_noflip(6,"re-install the game. If you are sure press A, else press HOME.");
#endif
		OSScreenFlipBuffersEx(0);
		OSScreenFlipBuffersEx(1);
		usleep(25000);
